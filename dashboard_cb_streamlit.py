...
# =============================================================
col_logo, col_judul = st.columns([1.5, 15])
with col_logo: 
...
with tab_utama:
    ...
    if peringatan_aktif is not None:
        ...
        st.info("Belum ada peringatan resmi yang aktif saat ini. Forecaster dapat membuat peringatan baru di menu 'Pembuatan PDF'.")
